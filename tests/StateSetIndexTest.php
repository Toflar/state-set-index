...
class StateSetIndexTest extends TestCase
{
    ...
    public function testResultsMatchResearchPaper(): void
    {
        ...
        $this->assertSame([
            1811 => ['Mueller'],
            1869 => ['Müller', 'Multere'],
            1677 => ['Muster', 'Mustermann'],
        ], $stateSetIndex->findAcceptedStrings('Mustre', 2, 2));
    ...
    public function testTranspositionsCanBeFound(): void
    {
        ...
        $this->assertSame([
            123128 => ['abcdefg'],
        ], $stateSetIndex->findAcceptedStrings('abdcefg', 1, 1));
        $this->assertSame([
            123128 => ['abcdefg'],
        ], $stateSetIndex->findAcceptedStrings('bacdegf', 2, 1));
    ...
    public function testWithWordsCutOffByIndexLength(string $word, string $search, int $indexLength = 6, int $editDistance = 1): void
    {
        ...
        $this->assertSame([
            $state => [$word],
        ], $stateSetIndex->findAcceptedStrings($search, $editDistance, 1));
